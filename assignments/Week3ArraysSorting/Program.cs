    ...
    class Program
    {
        ...
        static void AccessBookCatalog(string[] args)
        {
            try
            {
                ...
                string bookFilePath = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "books.txt");
                ...
                {
                    Console.WriteLine($"Book file not found at {bookFilePath}. Creating a sample one...");
                    File.WriteAllLines(bookFilePath, new[]
                    {
                        "9780143127550,The Martian,Andy Weir",
                        "9780439139595,Harry Potter and the Goblet of Fire,J.K. Rowling",
