    ...
    class Program
    {
        ...
        static void HandleClearQueue()
        {
            ...
            if (ticketQueue.Count > 0)
            {
                ...
                {
                    Console.WriteLine("X Clear operation cancelled. No elements in the Queue\n");
                }
            }
        ...
        static void HandleUrgentTicket()
        {
            ...
            Console.WriteLine($"Description: {description}");
            Console.WriteLine($"Position in queue: {ticketQueue.Count}\n");
            Console.WriteLine($"▲ Note: In a real system, this would jump to front of queue\n");
        ...
        static void ShowSessionSummary()
        {
            ...
            if (ticketQueue.Count > 0)
            {
                ...
                Console.WriteLine("\n!Remember to process remaining tickets!");
            }
            else
            {
