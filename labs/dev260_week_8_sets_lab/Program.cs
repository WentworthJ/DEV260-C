...
namespace Lab8_Sets
{
    ...
    public class SetOperationsLab
    {
        ...
        public int DeduplicateEmails(List<string> emailList)
        {
            ...
            int orginalCount = emailList.Count;
            // case insensitive HashSet to store unique emails
            var uniqueEmailSet = new HashSet<string>(emailList, StringComparer.OrdinalIgnoreCase);

            
            // clear and repopulate the uniqueEmails set
            emailList.Clear();
            emailList.AddRange (uniqueEmailSet);
            // how many duplicates were removed
            int dupsRemoved = orginalCount - emailList.Count;
            return dupsRemoved;
        ...
        public int AddPermissions(string userId, HashSet<string> newPermissions)
        {
            ...
            // union with new permissions -> merges sets and avoids dupli 
        ...
        public HashSet<string> GetMissingPermissions(string userId, HashSet<string> requiredPermissions)
        {
            ...
            if (!userPermissions.ContainsKey(userId))
            {
                return new HashSet<string>(requiredPermissions); // Use
            }
        ...
        public HashSet<string> FindNewStudents()
        {
            ...
            // return enrolledNow. Except (enrolled LastQuarter). ToHashSet(); 
            return newStudents;
        ...
        public double CalculateRetentionRate()
        {
            ...
            double retentionRate = (double)continuingStudents.Count / enrolledLastQuarter.Count * 100;
