    ...
    public class SpellChecker
    {
        ...
        public bool AnalyzeTextFile(string filename)
        {
            ...
            try
            {
                ...
                // Remove punctuation except underscores and split on whitespace
                ...
                {
                    string normalized = NormalizeWord(t);
                    if (string.IsNullOrWhiteSpace(normalized))
                        continue;
        ...
        public (bool inDictionary, bool inText, int occurrences) CheckWord(string word)
        {
            ...
            int occurrences = inText
                ? allWordsInText.Count(w => w.Equals(normalized, StringComparison.OrdinalIgnoreCase))
                : 0;
